...
def oneComplementer():
    ...
    egyeskomplementer = str(convertFromTen(number,2,precision,drawed))
    print("  A számod binárisan: ", egyeskomplementer)
    i = 0
    result = ""
    ...
    print("  Az egyes komplementer: ", result)


def main():
    mainMenu = ["Átváltás tízes számrendszerből", "Átváltás tízes számrendszerbe", "Feladatsor generálása","Feladatsorok megtekintése","Beállítások","Segítség","Egyes komplementer", "Kilépés"]
    executableMenu = ["fromTen()", "toTen", "genExcercise()","lookExcercise()","settings()", "help()", "oneComplementer()"]
